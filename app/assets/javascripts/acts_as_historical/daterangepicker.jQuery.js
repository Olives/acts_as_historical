...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
      {text: 'Today', dateStart: 'Today', dateEnd: 'Today', custom: 1 },
			{text: 'Yesterday', dateStart: 'Yesterday', dateEnd: 'Yesterday', custom: 2 },
			{text: 'Last 7 days', dateStart: 'Today-7', dateEnd: 'Today-1', custom: 3 },
      {text: 'Month to date', custom: 4,
    ...
    jQuery("input#report_date_range_type").val("")
		if(jQuery(this).is('.ui-daterangepicker-specificDate')){
			...
			//custom date range
        jQuery("input#report_date_range_type").val(jQuery(this).data('custom'))
				doneBtn.hide();
